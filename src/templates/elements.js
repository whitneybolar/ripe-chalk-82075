            ...
            <Layout {...this.props}>
                ...
                <section>
                    ...
                    <div className="row">
                        ...
                        <div className="col-6 col-12-medium">
                            ...
                            <h3>Icons</h3>
                            <ul className="icons">
                                <li><Link to="#" className="icon style1 fa-twitter"><span className="label">Twitter</span></Link></li>
                                <li><Link to="#" className="icon style1 fa-facebook"><span className="label">Facebook</span></Link></li>
                                <li><Link to="#" className="icon style1 fa-instagram"><span className="label">Instagram</span></Link></li>
                                <li><Link to="#" className="icon style1 fa-github"><span className="label">Github</span></Link></li>
                            </ul>
                            <ul className="icons">
                                <li><Link to="#" className="icon style2 fa-twitter"><span className="label">Twitter</span></Link></li>
                                <li><Link to="#" className="icon style2 fa-facebook"><span className="label">Facebook</span></Link></li>
                                <li><Link to="#" className="icon style2 fa-instagram"><span className="label">Instagram</span></Link></li>
                                <li><Link to="#" className="icon style2 fa-github"><span className="label">Github</span></Link></li>
                            </ul>
                        </div>
                    </div>
                    <h2>Actions</h2>
                ...
                <section>
                    ...
                    <div className="box alt">
                        <div className="row gtr-uniform">
                            <div className="col-12"><span className="image fit"><img src="images/pic13.jpg" alt="" /></span></div>
